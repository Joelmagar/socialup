...
export default function Search() {
  ...
  return (
    <div className="w-full overflow-hidden h-full p-2  bg-background justify-normal">
      ...
      <div className="p-2  mt-10  flex justify-between items-center px-6 rounded-xl  bg-primary/70 border-b-2 border-b-[rgba(84,84,84,0.6)]">
        <input
          type="text"
